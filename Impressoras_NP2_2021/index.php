...
<body>
    <form class="index" action="config_verificar.php" class=""  method="GET">
    <h1 class="titulos">BEM VINDO!</h1>
        ...
        <a class="cadastrar" href="cadastro_usuario.php" type="submit" >CADASTRAR</a><br><br>
    </form>
